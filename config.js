const nameGirl = 'Nhất Anh';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng 8/3';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc cậu 8-3 tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với cậu trong hôm nay và cả những ngày sau.Bớt đần đi nha :))))';
